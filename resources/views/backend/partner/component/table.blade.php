<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <th>Tên đối tác</th>
        <th class="text-center" style="width: 250px;">Đường dẫn</th>
    ...
    @if(isset($records) && is_object($records))
        ...
        <tr >
            ...
            <td class="text-center"> 
                <a href="{{ route('partner.edit', $record->id) }}" class="btn btn-success"><i class="fa fa-edit"></i></a>
                <a href="{{ route('partner.delete', $record->id) }}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
            </td>
        </tr>
        @endforeach
    @endif
