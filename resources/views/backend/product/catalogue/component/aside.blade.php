...
<div class="ibox w">
    ...
    <div class="ibox-content">
        <div class="row">
            <div class="col-lg-12">
                <div class="form-row">
                    <span class="image img-cover image-target"><img src="{{ (old('image', ($productCatalogue->image) ?? '' ) ? old('image', ($productCatalogue->image) ?? '')   :  asset('vendor/backend/img/not-found.jpg')) }}" alt=""></span>
