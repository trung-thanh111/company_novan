    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <x-backend.filter
                    createRoute="team.create"
                    submitRoute="team.index" />
                @php
                $columns = [
                'avatar' => ['label' => 'Ảnh', 'render' => fn($item) => '<img src="'.asset($item->avatar ?? 'vendor/backend/img/not-found.jpg').'" style="width:50px;height:50px;border-radius:50%;object-fit:cover" />'],
                ...
                <x-backend.customtable
                    ...
                    :columns="$columns"
                    :actions="[
                        ['route' => 'team.edit', 'class' => 'btn-success', 'icon' => 'fa-edit'],
                        ['route' => 'team.delete', 'class' => 'btn-danger', 'icon' => 'fa-trash'],
                    ]"
                    :model="$config['model']" />
