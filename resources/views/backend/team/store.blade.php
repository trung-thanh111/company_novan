...
@endif
@php
$url = ($config['method'] == 'create') ? route('team.store') : route('team.update', $record->id);
@endphp
            ...
            <div class="col-lg-4">
                <div class="ibox">
                    ...
                    <div class="ibox-content text-center">
                        <div class="form-row">
                            <span class="image img-cover image-target"><img src="{{ old('avatar', ($record->avatar) ?? '' ) ? old('avatar', ($record->avatar) ?? '') :  asset('vendor/backend/img/not-found.jpg') }}" alt=""></span>
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row mb15">
                            <div class="col-lg-12">
                                <div class="form-row">
                                    <label for="" class="control-label text-left">Thiết lập</label>
                                    <div class="uk-flex uk-flex-middle">
                                        <input type="checkbox" name="is_primary" value="1" class="js-switch" {{ old('is_primary', $record->is_primary ?? 0) ? 'checked' : '' }}>
                                        <span class="ml10">Nhân viên chính (Hotline)</span>
                                    </div>
                                </div>
                            </div>
                        </div>
