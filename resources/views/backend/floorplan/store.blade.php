            ...
            <div class="col-lg-4">
                <div class="ibox">
                    ...
                    <div class="ibox-content text-center">
                        <div class="form-row">
                            <span class="image img-cover image-target"><img src="{{ old('plan_image', ($record->plan_image) ?? '' ) ? old('plan_image', ($record->plan_image) ?? '') :  asset('vendor/backend/img/not-found.jpg') }}" alt=""></span>
