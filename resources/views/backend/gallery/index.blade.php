    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                @php
                $columns = [
                'image' => ['label' => 'Hình ảnh đại diện', 'render' => fn($item) => '<img src="'.($item->image ? asset($item->image) : asset('vendor/backend/img/not-found.jpg')).'" style="width:100px;height:60px;object-fit:cover;border-radius:4px;" />'],
