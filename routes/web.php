...
require __DIR__ . '/web/service.route.php';
require __DIR__ . '/web/faq.route.php';
require __DIR__ . '/web/partner.route.php';
require __DIR__ . '/web/achievement.route.php';
require __DIR__ . '/web/core_value.route.php';
require __DIR__ . '/web/work_process.route.php';
