...
use App\Http\Controllers\Backend\V1\Team\TeamController;
...
Route::group(['middleware' => ['admin', 'locale', 'backend_default_locale'], 'as' => ''], function () {
    ...
    Route::get('team/{id}/edit', [TeamController::class, 'edit'])->where(['id' => '[0-9]+'])->name('team.edit');
    Route::post('team/{id}/update', [TeamController::class, 'update'])->where(['id' => '[0-9]+'])->name('team.update');
    Route::get('team/{id}/delete', [TeamController::class, 'delete'])->where(['id' => '[0-9]+'])->name('team.delete');
    Route::delete('team/{id}/destroy', [TeamController::class, 'destroy'])->where(['id' => '[0-9]+'])->name('team.destroy');
